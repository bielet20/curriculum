...
COPY perfil.jpg /usr/share/nginx/html/ 2>/dev/null || echo "perfil.jpg no encontrado, usando placeholder"
COPY perfil.mp4 /usr/share/nginx/html/ 2>/dev/null || echo "perfil.mp4 no encontrado, usando placeholder"
